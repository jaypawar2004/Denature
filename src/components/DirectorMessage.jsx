...
//       </div>
//     </section>
<section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 lg:py-24 font-sans overflow-hidden">
      {/* - Mobile: 1 column
         - Tablet (md): 12 columns grid (Text: 7, Image: 5) side-by-side
         - Desktop (lg): Text: 8, Image: 4 (Image thodi aur choti ho jayegi)
      */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 lg:gap-12 items-start">
        
        {/* Left Side: Content Area (Mobile pe pehle dikhega) */}
        <div className="md:col-span-7 lg:col-span-8 p-2 sm:p-4 flex flex-col justify-center order-1">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <div className="space-y-6 text-slate-700 text-base md:text-lg leading-relaxed">
              ...
              <div className="mt-10 pt-8 border-t border-slate-100">
                ...
                <p className="italic text-slate-600 mb-6 bg-slate-50 p-4 rounded-2xl border-l-4 border-[#5CCBEA]">
                  "I’m the founder of Tigris Smile, a qualified Dental Prosthetist with a Bachelor degree in Dental Prosthetics, and I also hold qualifications in Dental technology."
                </p>
                <div className="space-y-4">
                  <p>
                  ...
                  <p className="font-bold text-slate-900 bg-[#E6F7FB]/30 p-4 rounded-3xl">
                    At Tigris Smile, my goal is to provide compassionate, personalised care while helping patients feel seen, supported, and confident again. Every smile has a story, and I am honoured to be part of that journey.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-10 pt-6 border-t border-slate-100">
              <h4 className="text-xl font-bold text-[#0f172a]">D.P Shahad Hussein</h4>
              <p className="text-[#5CCBEA] font-semibold text-sm md:text-base uppercase tracking-wider">Dental Practitioner & CEO</p>
            </div>
          </motion.div>
        </div>

        {/* Right Side: Image Container (Tablet aur Desktop par perfect aspect ratio maintain karega) */}
        <div className="md:col-span-5 lg:col-span-4 relative w-full aspect-[3/4] sm:aspect-[4/5] md:aspect-[3/4] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden shadow-md order-2 mt-8 md:mt-0 self-start">
          <Image 
            src="/images/denatureSecondImg.jpeg" 
            alt="Clinical Director - Tigris Smile" 
            fill
            className="object-cover object-center"

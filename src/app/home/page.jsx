...
//       <section className="max-w-7xl mx-auto px-8 py-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start md:mt-15 mt-15">
...
//               </select>
//               <button className="bg-[#ccfbf1] text-[#134e4a] px-8 py-3 rounded-full font-bold mt-4 hover:bg-[#99f6e4] transition-all">
//                 Submit
//               </button>
//             </form>
//           </div>
...
//             </p>
//             <button className="border-2 border-[#1C5954] text-[#1C5954] px-6 py-2 rounded-full font-semibold hover:bg-[#99F6E4] hover:text-[#1C5954] transition-all">
...
//             <Image 
//               src="https://plus.unsplash.com/premium_photo-1664475354661-4328fbb428ed?q=80&w=1172&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" // Replace with your actual image path
      ...
      <section className="max-w-7xl mx-auto px-8 py-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mt-20 md:mt-24">
        ...
        <div className="space-y-6 lg:space-y-10 order-1">
          ...
          <div className="block lg:hidden relative h-[300px] w-full rounded-3xl overflow-hidden shadow-2xl">
            <Image 
              src="https://plus.unsplash.com/premium_photo-1664475354661-4328fbb428ed?q=80&w=1172&auto=format&fit=crop"
              alt="Professional Dental Service"
              fill
              className="object-cover"
              priority
